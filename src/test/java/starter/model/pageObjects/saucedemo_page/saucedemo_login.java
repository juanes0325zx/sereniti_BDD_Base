...
public class saucedemo_login {
    ...
    public static By txt_user_login = By.xpath("//input[@class='input_error form_input' and @id='user-name']");
    public static By txt_user_pass = By.xpath("//input[@class='input_error form_input' and @id='password']");
